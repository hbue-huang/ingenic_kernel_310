...
#define AES_ASINTM    (0x08)
#define AES_ASSA      (0x0c)
#define AES_ASSTC	  (0x10)
#define AES_ASDA      (0x14)
#define AES_ASDTC	  (0x18)
#define AES_ASBNUM	  (0X1c)
...
#define ASCR_USER_KEY(user_key)   ((user_key) << 19)
#define ASCR_KEY_MODE(key_mode)   ((key_mode) << 16)
#endif
